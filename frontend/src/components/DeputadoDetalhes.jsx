...
/**
 * Componente principal para exibir detalhes completos do deputado
 * Integrado com APIs oficiais e sistema de abas moderno
 */
...
/**
 * Aba de Participações em Reuniões
    ...
    <div className="aba-conteudo">
      <div className="aba-header">
        ...
        <p className="aba-descricao">
          Eventos, reuniões e sessões que o deputado participou recentemente
        </p>
      </div>
      ...
      <div className="participacoes-lista">
        {deputado.participacoes && deputado.participacoes.length > 0 ? (
          ...
          <EmptyState
            icon={Users}
            message="Nenhuma participação em eventos encontrada para este deputado"
          />
        )}
      </div>
    </div>
...
/**
 * Aba de Autoria em Projetos de Lei
...
const ProjetosTab = ({ deputado, onRetry }) => {
  ...
  const getStatusClass = (status) => {
    return `projeto-status status-${status.toLowerCase().replace(/\s+/g, "-")}`;
  };
  ...
  return (
    <div className="aba-conteudo">
      <div className="aba-header">
        ...
        <p className="aba-descricao">
          Proposições e projetos de lei de autoria do deputado
        </p>
      </div>
      ...
      <div className="projetos-lista">
        {deputado.projetos && deputado.projetos.length > 0 ? (
          deputado.projetos.map((projeto, index) => (
            <div key={index} className="projeto-item">
              <div className="projeto-item__cabecalho">
                ...
                <span className={getStatusClass(projeto.status)}>
              ...
              <div className="projeto-acoes">
                <button className="btn-projeto-detalhes">
          ...
          <EmptyState
            icon={FileText}
            message="Nenhuma proposição de autoria encontrada para este deputado"
          />
        )}
      </div>
    </div>
  ...
  return (
    <div className="aba-conteudo">
      <div className="aba-header">
        ...
        <p className="aba-descricao">
          Mandatos, comissões, órgãos e histórico político do deputado
        </p>
      </div>
    ...
    <div className="aba-conteudo">
      ...
      {deputado.orcamento ? (
        <>
          ...
          {/* Fonte dos Dados */}
          <div className="orcamento-fonte">
            <p className="fonte-texto">
              <ExternalLink size={14} />
              Dados obtidos da API oficial da Câmara dos Deputados
            </p>
          </div>
        </>
      ) : (
...
/**
 * Componente principal da página de detalhes do deputado
 */
const DeputadoDetalhes = () => {
    ...
    switch (abaSelecionada) {
      case "participacao":
        return (
          <ParticipacaoTab
            deputado={deputado}
            onRetry={() => atualizarDados("participacao")}
          />
        );
      case "projetos":
        return (
          <ProjetosTab
            deputado={deputado}
            onRetry={() => atualizarDados("projetos")}
          />
        );
      case "atividades":
        return (
          <AtividadesTab
            deputado={deputado}
            onRetry={() => atualizarDados("atividades")}
          />
        );
      case "orcamento":
        return (
          <OrcamentoTab
            deputado={deputado}
            onRetry={() => atualizarDados("orcamento")}
          />
        );
      default:
        return (
  ...
  if (carregando) {
    return (
      <div className="deputado-detalhes">
        <div className="deputado-detalhes__carregando">
  ...
  if (erro) {
    return (
      <div className="deputado-detalhes">
        <div className="deputado-detalhes__erro">
          <AlertCircle size={48} />
  ...
  if (!deputado) {
    return (
      <div className="deputado-detalhes">
        <div className="deputado-detalhes__sem-resultados">
          <AlertCircle size={48} />
